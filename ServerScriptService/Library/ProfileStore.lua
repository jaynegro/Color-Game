...
if IsStudio == true then
	...
	-- This experience deliberately uses ProfileStore.Mock in Studio. Skip the
	-- library's API probe write so Play tests can never touch live DataStores.
	DataStoreState = "NoAccess"
	ProfileStore.DataStoreState = "NoAccess"
	print(`[{script.Name}]: Studio session-only mode - using mock profiles without DataStore access`)
